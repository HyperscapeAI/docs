...
<CardGroup cols={2}>
  ...
  <Card title="Trading System" icon="handshake" href="/wiki/game-systems/trading">
    Player-to-player trading with OSRS-style two-screen confirmation and anti-scam protections.
  </Card>
  ...
  <Card title="Lighting & Day/Night" icon="sun" href="/wiki/game-systems/lighting">
    Dynamic lighting, auto exposure, and atmospheric day/night transitions.
  </Card>
  <Card title="Equipment Visuals" icon="shirt" href="/wiki/game-systems/equipment-visuals">
    VRM avatar equipment rendering, V2 fitting format, and gathering tool display.
  </Card>
</CardGroup>
