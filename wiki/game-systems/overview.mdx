...
| Skill | Purpose |
|-------|---------|
| **Agility** | Trains from movement, improves stamina regeneration |

<Info>
  Each skill has independent XP tracking and levels 1-99 following OSRS XP curves. Agility trains passively as you move (1 XP per 2 tiles).
</Info>
