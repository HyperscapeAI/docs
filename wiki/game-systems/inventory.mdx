...
- **OSRS-style right-click context menus** with manifest-driven actions
- **Left-click primary actions** (Eat, Wield, Use, etc.)
- Stack quantity display
- Coin pouch separate display
- **Cancel option** at bottom of all context menus
...
The `InventoryActionDispatcher` is the **single source of truth** for handling inventory actions:
