...
<Info>
Fletching follows OSRS mechanics: use a knife on logs to create arrow shafts or unstrung bows, then use bowstring to finish bows. Arrowtips are created through Smithing.
</Info>

**Runecrafting** (`recipes/runecrafting.json`):

Runecrafting allows players to craft magical runes from essence at runecrafting altars.

| Rune | Level | XP per Essence | Essence Types | Multi-Rune Levels |
|------|-------|----------------|---------------|-------------------|
