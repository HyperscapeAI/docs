...
| Skill | Description | Training Methods |
|-------|-------------|------------------|
| **Agility** | Stamina regeneration | Walking and running across the world |
...
Agility is a unique skill that rewards players for traversing the game world and directly impacts stamina mechanics.
...
**XP Rates**:
| Movement Type | Tiles/Second | XP/Minute | Time to Level 50 |
|---------------|--------------|-----------|------------------|
| Walking | 3.33 | ~100 XP | ~17 hours |
| Running | 6.67 | ~200 XP | ~8.5 hours |

<Info>
Agility XP is granted automatically as you move around the world - no special actions required!
</Info>

### Stamina Regeneration Bonus

Agility provides a **+1% stamina regen bonus per level**:
...
<Warning>
Heavy loads significantly increase stamina drain. Manage your inventory weight for optimal running efficiency. The Equipment Panel displays your total weight.
</Warning>

### Combined Effects

High agility can partially offset heavy weight penalties:

**Example**: Level 50 Agility with 50kg load
- Weight increases drain by 25% (2.0 → 2.5/sec)
- Agility increases idle regen by 50% (4.0 → 6.0/sec)
- Net effect: Still regenerate faster than you drain while idle
...
- Loading state while fetching unlock data from server

<Info>
The Skill Guide Panel helps players plan their progression by showing what they'll unlock at future levels. Data is fetched from the server endpoint `/api/data/skill-unlocks`.
</Info>
