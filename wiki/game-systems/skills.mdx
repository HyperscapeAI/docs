...
With 12 skills at level 99 (Constitution starts at 10): **1,197 total level**
...
Agility is a passive skill that trains automatically as you move through the world:

**XP Mechanics**:
- **Rate**: 1 XP per 2 tiles traveled
- **Batching**: XP is granted in batches of 50 XP every 100 tiles
...
**Stamina Benefits**:
- **Regeneration Bonus**: +1% stamina regen per agility level
...
- **Heavy Load**: 50kg load = +25% drain = 2.5 stamina/second
...
<Warning>
Teleportation does not grant agility XP - only walking and running count toward the tile counter.
</Warning>
