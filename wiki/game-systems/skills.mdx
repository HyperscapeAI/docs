...
| **Smelt mithril bar** | **30** |
| **Smelt adamant bar** | **37.5** |
| **Smelt rune bar** | **50** |
| **Smith bronze sword** | **12.5** |
| **Smith iron platebody** | **125** |
| **Smith steel platelegs** | **75** |
| **Smith mithril scimitar** | **100** |
...
Smithing is a two-stage artisan skill that allows players to create metal equipment.

### Stage 1: Smelting (Furnace)

Convert ores into metal bars at a furnace.

**Requirements:**
- Ores in inventory (copper, tin, iron, coal, etc.)
- Access to a furnace

**Process:**
1. Click on a furnace
2. Select the bar type to smelt
3. Choose quantity (1, 5, 10, All, or custom X)
4. Wait for smelting to complete (4 ticks per bar)
...
<Warning>
**Iron Ore Failure**: Iron ore has a 50% chance to fail when smelting, consuming the ore without producing a bar. This matches OSRS mechanics.
</Warning>

### Stage 2: Smithing (Anvil)

Convert metal bars into equipment at an anvil.
...
**Process:**
1. Click on an anvil
2. Select the item to smith
3. Choose quantity (1, 5, 10, All, or custom X)
4. Wait for smithing to complete (4 ticks per item)

**Smithing Categories:**

Items are organized by category in the smithing interface:

- **Weapons**: Swords, scimitars, daggers, axes, maces
- **Armor**: Helmets, platebodies, platelegs, shields
- **Tools**: Pickaxes, hatchets
- **Misc**: Nails, arrowtips, dart tips
...
| Iron Scimitar | 20 | 2 Iron | 50 | Weapons |
| Steel Platelegs | 36 | 3 Steel | 75 | Armor |
| Mithril Pickaxe | 54 | 2 Mithril | 100 | Tools |

### Tick-Based Timing

Both smelting and smithing use OSRS-accurate tick-based timing:

- **1 tick = 600ms** (game tick duration)
- **Smelting**: 4 ticks per bar (2.4 seconds)
- **Smithing**: 4 ticks per item (2.4 seconds)

Actions are queued and processed on tick boundaries, not immediately when requested.
...
This matches OSRS's "Make X" memory feature and persists in browser localStorage.
...
// Returns: { primaryOre, secondaryOre, coalRequired, levelRequired, xp, successRate, ticks }
