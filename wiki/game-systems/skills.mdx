...
| **Crafting** | Create leather armor and jewelry | Crafting leather armor, cutting gems, making jewelry |
...
| Item | Level | XP | Notes |
|------|-------|-----|-------|
| Arrow shafts (×15) | 1 | 5 | From logs |
| Shortbow (u) | 5 | 5 | Unstrung shortbow |
| Longbow (u) | 10 | 10 | Unstrung longbow |
| Headless arrows (×15) | 1 | 15 | Shafts + feathers |
| Bronze arrows (×15) | 1 | 19.5 | Headless + arrowtips |
| Magic shortbow (u) | 80 | 83.3 | Highest tier shortbow |
| Magic longbow (u) | 85 | 91.5 | Highest tier longbow |

**Crafting** (`recipes/crafting.json`):
| Item | Level | XP | Notes |
|------|-------|-----|-------|
| Leather gloves | 1 | 13.8 | Needle + thread |
| Leather body | 14 | 25 | Needle + thread |
| Studded body | 41 | 40 | Leather + steel studs |
| Green d'hide body | 63 | 186 | 3 green dragon leather |
| Sapphire | 20 | 50 | Cut gem with chisel |
| Amulet of power | 70 | 100 | Gold bar + diamond |
| Amulet of glory | 80 | 150 | Gold bar + dragonstone |
