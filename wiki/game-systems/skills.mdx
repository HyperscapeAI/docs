...
Prayer is trained by burying bones dropped by monsters:

**Bone Types** (defined in item manifests):
| Bone | Prayer XP | Dropped By |
|------|-----------|------------|
| Bones | 4.5 | Most monsters |
| Big Bones | 15 | Larger monsters |
| Dragon Bones | 72 | Dragons |
...
**Burying Mechanics**:
- 2-tick (1.2 second) delay between burying bones
- Bones consumed from inventory
- XP granted immediately
- Message shown: "You bury the bones."
...
<Info>
**Prayer Training**: Burying bones is routed through the `useItem` flow for proper server-side handling. The server detects bone items and processes them as bury actions.
</Info>
