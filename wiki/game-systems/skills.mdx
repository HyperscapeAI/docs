...
| **Prayer** | Prayer points & bonuses | Burying bones, using altars |
...
Combat level is calculated from combat skills using the OSRS formula. **Prayer contributes to combat level** at half its value.
...
<Info>
**Prayer Impact**: Prayer level contributes to combat level at half its value (floor(Prayer / 2)). A player with 99 Prayer gains +12 combat levels from Prayer alone.
</Info>
```
