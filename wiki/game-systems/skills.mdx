...
Players can view all unlocks for a skill by **clicking on the skill icon** in the Skills panel. This opens an OSRS-style guide showing:
...
- Shows current level and unlock progress (e.g., "15/29 unlocked")
- Next unlock highlighted with "X more levels to unlock..." message
...
<Info>
The Skill Guide Panel matches OSRS visual design with dark brown backgrounds, gold accents, and smooth animations.
</Info>
