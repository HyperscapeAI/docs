...
<Info>
**Recent Update (PR #886)**: Player movement now uses BFS as the primary pathfinder instead of naive diagonal-first. This eliminates visible diagonal zigzag when walking to attack targets and matches OSRS "smartpathing" behavior.
</Info>
