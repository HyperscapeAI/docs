...
**Bank Packet Protocol** (commit 593cd56b):

The old `bankAction` packet was broken. The new protocol uses proper packet sequence:
...
**Related Changes**:
- **Action locks** prevent LLM ticks while movement is in progress
