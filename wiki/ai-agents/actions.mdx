...
<CardGroup cols={3}>
  ...
  <Card title="Questing" icon="scroll">
...
### `chopTree` <Badge text="Updated" variant="info" />
...
**Approach Range**: 40m (increased from 20m in commit 593cd56b to fix "choppableTrees=0" errors despite visible trees)

**How to Get Hatchet**: Accept quest `lumberjacks_first_lesson` from Forester Wilma (grants Bronze Hatchet + Tinderbox immediately)

---

### `mineRock` <Badge text="Updated" variant="info" />
...
**Approach Range**: 40m (increased from 20m in commit 593cd56b to match skills validation)

**How to Get Pickaxe**: Accept quest `torvins_tools` from Torvin (grants Bronze Pickaxe + Hammer immediately)

---

### `catchFish` <Badge text="Updated" variant="info" />
...
**Requirements**: Fishing net or rod in inventory, Fishing level.

**Approach Range**: 40m (increased from 20m in commit 593cd56b)

**How to Get Fishing Net**: Accept quest `fresh_catch` from Fisherman Pete (grants Small Fishing Net immediately)
...
2. Walks to bank if distance > 5 units
3. Opens bank session
4. Deposits specified item
5. Closes bank session
...
2. Walks to bank if distance > 5 units
3. Opens bank session
4. Withdraws specified item
5. Closes bank session

---

### `bankDepositAll` <Badge text="New" variant="success" />

Deposit all non-essential items at the bank. Keeps essential tools (axe, pickaxe, tinderbox, fishing net).
...
2. Walks to bank if distance > 5 units
3. Opens bank session
4. Deposits ALL items
5. Withdraws back essential tools (axe, pickaxe, tinderbox, net)
6. Closes bank session
...
<Info>
  This action replaced the old `LOOT_STARTER_CHEST` action as part of the quest-driven progression system (commit 593cd56b).
</Info>
...
**Usage**: Get starter tools and rewards from quests.
