...
<Info>
The server enforces a 200-tile maximum movement distance per command. NAVIGATE_TO automatically breaks long journeys into multiple steps.
</Info>
...
- Action automatically finds nearest cardinal tile and walks there
- Ensures proper face direction for gathering animation

<Info>
The cardinal positioning requirement ensures consistent face direction during woodcutting, matching OSRS behavior.
</Info>
