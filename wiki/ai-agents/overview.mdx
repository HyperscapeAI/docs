...
Hyperscape agents use a **THINKING+ACTION** format that enables genuine LLM reasoning:

### THINKING+ACTION Format

Agents respond with structured reasoning before taking action:

```
<THINKING>
I have 3 goblins attacking me and my health is at 40%. I have food in my inventory.
...
`getCombatReadiness()` evaluates agent's combat preparedness:
...
The plugin provides **24 actions** across 9 categories:
