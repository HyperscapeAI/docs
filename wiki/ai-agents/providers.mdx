...
8. **possibilitiesProvider** - What actions are currently possible (crafting, gathering, combat)
9. **goalTemplatesProvider** - Structured goal templates for OSRS beginner flows
10. **guardrailsProvider** - Safety constraints and warnings
