...
Tools can optionally include a `tool` object specifying the skill and priority:
...
Tools now use a priority system to determine which tool to use when multiple are available:
