...
| Station | Purpose | Model |
|---------|---------|-------|
| **Anvil** | Smithing bars into equipment | `models/anvil/anvil.glb` |
| **Furnace** | Smelting ores into bars | `models/furnace/furnace.glb` |
| **Cooking Range** | Cooking food (reduced burn chance) | TBD |
| **Bank Booth** | Accessing bank storage | TBD |
