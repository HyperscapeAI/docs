...
| **Range** | Cook food with reduced burn chance | Loaded from manifest | 1.0 | 0 |
| **Bank** | Store items | Loaded from manifest | 1.0 | 0 |
| **Altar** | Prayer restoration | Loaded from manifest | 1.0 | 0 |
