...
| `player_deaths` | Death locks for crash recovery | DeathStateManager |
...
| `0017_add_death_recovery_columns.sql` | Added crash recovery fields to `player_deaths` |
| `0016_add_prayer_system.sql` | Added Prayer skill and prayer points |
