...
| `EquipmentPanel.tsx` | Equipment slots with stat display and total weight |
| `SkillsPanel.tsx` | All 12 skills with XP progress bars and click-to-view guides |
| `SkillGuidePanel.tsx` | Skill unlock progression viewer (OSRS-style) |
...
The Skill Guide Panel is an OSRS-inspired interface that shows skill unlock progression:

**Features:**
- Click any skill in the Skills Panel to open its guide
...
- Type badges for unlock categories (item, ability, area, quest, activity)
...
**Data Source:**
- Fetches from `/api/data/skill-unlocks` endpoint
- Server-authoritative unlock definitions
- Cached for 5 minutes

<Info>
The Skill Guide Panel helps players plan their progression by showing what they'll unlock at each level.
</Info>
