...
| `SkillsPanel.tsx` | All skills with XP progress bars and clickable skill guides |
| `SkillGuidePanel.tsx` | OSRS-style skill unlock viewer (click any skill to open) |
...
Click any skill in the Skills Panel to view its unlock progression:
...
**Data Source**: Fetched from `/api/data/skill-unlocks` endpoint
