...
| `SkillsPanel.tsx` | All skills with XP progress bars and clickable skill icons |
| `SkillGuidePanel.tsx` | OSRS-style skill guide showing unlocks at each level |
...
The Skill Guide Panel is an OSRS-style popup that displays what players unlock at each level for a skill:
...
**Visual states:**
- **Unlocked**: Green background, checkmark, full opacity
- **Next unlock**: Gold highlight, arrow icon, "X more levels" indicator
- **Locked**: Dimmed, lock icon, gray text
