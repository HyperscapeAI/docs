...
Returns a map of skill names to unlock arrays:
...
<Info>
This endpoint is used by the Skill Guide Panel to display level-based unlocks. Data is server-authoritative and loaded from `skill-unlocks.json` manifest.
</Info>
