...
<Info>
This endpoint is used by the Skill Guide Panel to display what players unlock at each level. The data is server-authoritative and loaded from `skill-unlocks.json` manifest.
</Info>
