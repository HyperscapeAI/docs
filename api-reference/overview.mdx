...
Returns a mapping of skill names to arrays of unlock entries. Each unlock specifies the level requirement, description, and type (item/ability/area/quest/activity).
...
<Info>
This endpoint is used by the Skill Guide Panel to display unlock progression. Data is server-authoritative and loaded from `manifests/skill-unlocks.json`.
</Info>
