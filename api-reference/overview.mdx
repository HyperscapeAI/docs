...
<ParamField path="GET /api/agents/mapping/:agentId" type="endpoint">
  Get character ID for an AI agent
</ParamField>

<ParamField path="GET /api/agents/:agentId/goal" type="endpoint">
  Get current goal and available goals for an agent
</ParamField>

<ParamField path="POST /api/agents/:agentId/goal" type="endpoint">
  Set a new goal for an agent
</ParamField>
...
<ParamField path="GET /api/agents/:agentId/quick-actions" type="endpoint">
  Get quick action menu data (nearby locations, goals, inventory)
</ParamField>

### Character Data

<ParamField path="GET /api/characters/:characterId/skills" type="endpoint">
  Get character skill levels and XP
</ParamField>

<ParamField path="GET /api/characters/:characterId/position" type="endpoint">
...
<ParamField path="GET /api/data/skill-unlocks" type="endpoint">
  Get skill unlock definitions from manifest
</ParamField>
