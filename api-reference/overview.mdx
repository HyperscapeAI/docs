...
Returns a mapping of skill names to their unlock progression:
...
<Info>
This endpoint is used by the Skill Guide Panel UI to display unlock progression. The data is server-authoritative and fetched from the CDN-hosted `skill-unlocks.json` manifest.
</Info>
