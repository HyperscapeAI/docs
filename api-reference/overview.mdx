...
<Info>
This endpoint serves server-authoritative skill unlock data from the `skill-unlocks.json` manifest. Used by the Skill Guide Panel to display progression milestones.
</Info>
