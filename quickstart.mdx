...
8. **Train Agility** - Move around the world to gain passive Agility XP (1 XP per 2 tiles)
9. **View skill guides** - Click any skill in the Skills Panel to see unlock progression
