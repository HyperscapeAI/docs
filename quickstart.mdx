...
5. **Talk to NPCs** - Start quests for rewards (quest points, items, XP)
6. **Visit shops** - Buy tools (hatchet, fishing rod, tinderbox, hammer)
7. **Train gathering skills** - Chop trees, mine ore, fish
8. **Train artisan skills** - Light fires, cook food, smelt bars, smith equipment
9. **Open Quest Journal** - Click the 📜 icon to track quest progress
