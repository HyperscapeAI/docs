...
5. **Visit shops** - Buy tools (hatchet, fishing rod, tinderbox)
6. **Train skills** - Chop trees, fish, cook food
...
# Development  
bun run dev               # All packages with hot reload (via dev-with-elizaos.mjs)
bun run dev:elizaos       # With AI agents (START_ELIZAOS=true)
