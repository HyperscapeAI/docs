...
| PostgreSQL | 5432 | Database (Docker, auto-started) |
...
| Assets | Cloudflare R2 | https://assets.hyperscape.club |

<Info>
Production uses a split deployment model for optimal performance and global CDN distribution.
</Info>
