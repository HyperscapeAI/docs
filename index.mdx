...
<Tabs>
  ...
  <Tab title="Economy">
    ...
    | **Bank** | 480-slot storage with tabs, placeholders, and stackable item support |
    | **Shops** | General stores with buy/sell and race condition prevention |
    ...
    | **Collision** | Zone-based tile collision with automatic footprint detection |
  </Tab>
  <Tab title="AI Agents">
