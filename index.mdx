...
<Tabs>
  ...
  <Tab title="Skills">
    ...
    | **Crafting** | Artisan — create leather armor, dragonhide, jewelry, cut gems |
    | **Fletching** | Artisan — create bows, arrows, and arrow components |
    | **Runecrafting** | Artisan — convert essence into runes at altars |
  </Tab>
  <Tab title="Economy">
    | Feature | Details |
    |---------|---------|
