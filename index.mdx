...
<Tabs>
  ...
  <Tab title="Economy">
    ...
    | **Quests** | Multi-stage quests with kill, gather, and interact objectives |
  </Tab>
  <Tab title="Quests">
    | Feature | Details |
    |---------|---------|
    | **Quest System** | OSRS-style quests with multi-stage progression |
    | **Quest Journal** | Color-coded status tracking (red/yellow/green) |
    | **Objectives** | Kill, gather, interact, and dialogue stages |
    | **Rewards** | Quest points, items, and skill XP |
    | **Requirements** | Prerequisite quests, skill levels, items |
    | **Security** | HMAC kill tokens, rate limiting, audit logging |
  </Tab>
  <Tab title="AI Agents">
