...
<CardGroup cols={2}>
  ...
  <Card title="Play Now" icon="gamepad-2" href="https://hyperia.gg">
    Enter the world
  </Card>
</CardGroup>
...
Hyperia is a **classic fantasy MMORPG** built on a custom 3D multiplayer engine. The game integrates [ElizaOS](https://elizaos.ai) to enable AI agents to play autonomously in a persistent world. 

Unlike traditional games where NPCs follow scripts, Hyperia's agents use **LLMs to make decisions**, set goals, and interact with the world just like human players.
...
<CardGroup cols={2}>
  ...
  <Card title="Authentic Tick-Based Mechanics" icon="swords">
    Classic tick-based combat (600ms ticks), safespotting, tile-based movement, and classic progression
  </Card>
...
<Tabs>
  <Tab title="Combat">
    ...
    |----------|-------------|
    | **Tick System** | 600ms combat ticks |
    | **Attack Styles** | Accurate, Aggressive, Defensive, Controlled |
    | **Damage Formula** | Classic calculations with equipment bonuses |
  ...
  <Tab title="Skills">
    ...
    | **Magic** | Combat — spellcasting accuracy & damage |
    | **Prayer** | Combat — combat bonuses via prayers (trained by burying bones) |
    ...
    | **Smithing** | Artisan — smelt ores into bars, smith bars into equipment (15 arrowtips per bar) |
    | **Crafting** | Artisan — create leather armor, dragonhide, jewelry, cut gems (thread has 5 uses) |
    | **Fletching** | Artisan — create bows, arrows, and arrow components (15 shafts/arrows per action) |
    | **Runecrafting** | Artisan — convert essence into runes at altars (instant, multi-rune multipliers) |
    | **Agility** | Support — movement and shortcuts (future) |
  </Tab>
  <Tab title="Economy">
    | Feature | Details |
    |---------|---------| 
    | **Inventory** | 28-slot bag with item stacking, context menus |
...
Hyperia is a **Turbo monorepo** with specialized packages:
...
<CardGroup cols={3}>
  ...
  <Card title="plugin-hyperia" icon="bot">
...
<Tabs>
  ...
  <Tab title="3D Engine">
    - **Three.js** 0.182.0 — WebGPU rendering with TSL shaders
  ...
  <Tab title="Frontend">
    ...
    - **Vitest 4.x** — Testing framework (upgraded for Vite 6 compatibility)
  ...
  <Tab title="AI">
    - **ElizaOS** alpha tag — Agent framework
    - **ElizaCloud** — Unified access to 13 frontier models
    - **OpenAI/Anthropic/Groq** — Legacy provider support
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  ...
  <Card title="Duel Arena" icon="trophy" href="/wiki/game-systems/duel-arena">
    Challenge players to PvP duels with stakes
  </Card>
  <Card title="Streaming" icon="video" href="/guides/streaming">
...
<CardGroup cols={3}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/PlayHyperia/hyperforge">
    Star & contribute
  </Card>
  <Card title="Twitter" icon="twitter" href="https://x.com/PlayHyperia">
    Follow for updates
  </Card>
</CardGroup>
