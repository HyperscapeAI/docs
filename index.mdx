...
<Tabs>
  ...
  <Tab title="Skills">
    ...
    | **Prayer** | Support — activate prayers for combat bonuses |
    ...
    | **Quests** | Progression — complete quests for quest points and XP lamps |
  </Tab>
  <Tab title="Economy">
    | Feature | Details |
    |---------|---------|
    ...
    | **Quests** | OSRS-style quest journal with kill tracking and XP lamp rewards |
  </Tab>
  <Tab title="Quests">
    | Feature | Details |
    |---------|---------|
    | **Quest System** | OSRS-style multi-stage quests with objectives |
    | **Quest Points** | Permanent progression tracking |
    | **Objectives** | Kill, gather, interact, dialogue stages |
    | **Rewards** | Quest points, items, XP |
    | **Prerequisites** | Quest chains with skill/quest/item requirements |
    | **XP Lamps** | Choose which skill receives XP reward |
  </Tab>
  <Tab title="Quests">
    | Feature | Details |
    |---------|---------|
    | **Quest System** | Multi-stage progression with kill, gather, and interact objectives |
    | **Quest Points** | Character-level quest point tracking |
    | **Quest Journal** | OSRS-style UI with color-coded status and progress counters |
