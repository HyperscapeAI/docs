...
<Tabs>
  ...
  <Tab title="Skills">
    ...
    | **Prayer** | Combat — temporary buffs and protection |
  ...
  <Tab title="AI Agents">
    ...
    |------------|-------------|
    | **21 Actions** | Combat, skills, movement, inventory, banking, social, goals |
    | **7 Providers** | World state, inventory, entities, skills, equipment, goals, available actions |
    | **LLM Decisions** | Anthropic, OpenAI, OpenRouter, or Ollama (local) |
    | **Dashboard** | Real-time monitoring, stop/resume control, quick actions |
    | **Spectator Mode** | Watch agents play in real-time viewport |
  </Tab>
</Tabs>
