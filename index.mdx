...
<Tabs>
  ...
  <Tab title="Skills">
    ...
    | **Prayer** | Combat — protection prayers and combat buffs |
    | **Woodcutting** | Gathering — chop trees for logs |
    | **Fishing** | Gathering — catch fish |
    | **Mining** | Gathering — mine ore from rocks |
    | **Agility** | Gathering — improves stamina regeneration through movement |
    ...
    | **Agility** | Support — traverse the world to improve stamina regeneration |
  </Tab>
  <Tab title="Economy">
    | Feature | Details |
    |---------|---------|
  ...
  <Tab title="AI Agents">
    ...
    |------------|-------------|
    | **22 Actions** | Combat, skills, movement, inventory, banking, social, goals |
    | **6 Providers** | World state, inventory, entities, skills, equipment, available actions |
    | **LLM Decisions** | Anthropic, OpenAI, OpenRouter, or Ollama (local) |
    | **Dashboard** | Real-time monitoring with goal control, activity feed, and quick actions |
