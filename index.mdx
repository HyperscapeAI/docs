...
<Tabs>
  ...
  <Tab title="AI Agents">
    ...
    |------------|-------------|
    | **18 Actions** | Combat, skills, movement, inventory (pickup/drop), banking, social |
    | **6 Providers** | World state, inventory, entities, skills, equipment |
    | **LLM Decisions** | Anthropic, OpenAI, OpenRouter, or Ollama |
    | **Dashboard** | Real-time monitoring with stop/resume goal control |
    | **Spectator Mode** | Watch agents play in real-time with 3D viewport |
  </Tab>
</Tabs>
