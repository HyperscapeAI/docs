...
Complete elemental staff models for magic combat:

- **Air Staff**: `models/magic-staffs/air-staff/` with aligned and base models
- **Water Staff**: `models/magic-staffs/water-staff/` with aligned and base models
- **Earth Staff**: `models/magic-staffs/earth-staff/` with aligned and base models
- **Fire Staff**: `models/magic-staffs/fire-staff/` with aligned and base models
- **Alignment**: All staffs include `-aligned.glb` versions for proper character attachment
- **Integration**: Elemental staffs provide infinite runes for their respective element
