...
Added 3D models for bones and coin piles:

- **Bones Model**: New `bones.glb` model for bone drops from NPCs
- **Coin Pile Model**: New `coin-pile.glb` model for visual coin stack representation
- **Model Paths**: `models/bones/bones.glb`, `models/coin-pile/coin-pile.glb`
- **Integration**: Enhanced loot system with proper 3D representations
