...
export class Entity implements IEntity {
  ...
  // UI elements (health bars only - names shown in right-click menu)
...
The player entity extends CombatantEntity with player-specific features. Names are displayed in right-click context menus only (OSRS pattern) - no overhead nametags.
