...
**Mechanics:**
- Use "Bury" action on bones in inventory
- 2-tick (1.2 second) delay between burying
- Prayer points can be recharged at altars
- Prayer level = maximum prayer points

<Info>
  See the [Prayer System](/wiki/game-systems/prayer) documentation for complete details on prayer mechanics, drain formulas, and combat bonuses.
</Info>
