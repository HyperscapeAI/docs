...
XP lamps are quest rewards that allow players to choose which skill receives XP:
...
**Usage:**
1. Right-click lamp in inventory → "Rub"
2. Skill selection modal appears showing all 11 skills
3. Select skill to receive XP
4. Lamp consumed, XP granted

**Available Lamps:**
- `xp_lamp_100` — 100 XP
- `xp_lamp_1000` — 1,000 XP
- `xp_lamp_5000` — 5,000 XP

<Tip>
XP lamps are commonly awarded as quest rewards, allowing players to boost their preferred skill.
</Tip>
