...
| **Agility** | Traverse the world, affects stamina regeneration |
...
Agility is trained passively by moving around the world. Unlike traditional RuneScape agility courses, Hyperscape's agility system rewards exploration and travel.

**Training Method:**
- Gain 1 XP per 2 tiles traveled (walking or running)
- XP is batched every 100 tiles (50 XP) to prevent visual spam
- Death resets accumulated tile progress (not earned XP)

**Benefits:**
- **Stamina Regeneration**: +1% stamina regen per agility level
- **Weight Tolerance**: Higher agility helps offset stamina drain from heavy loads

**XP Rates:**
| Movement | XP per Minute |
|----------|---------------|
| Walking | ~100 XP |
| Running | ~200 XP |

<Info>
  Agility XP is granted in batches of 50 XP every 100 tiles to reduce visual spam. Running players see XP drops approximately every 15 seconds.
</Info>
