...
Create ranged weapons and ammunition from logs and other materials.

| Item | Level | Materials Required | XP |
|------|-------|-------------------|-----|
| Arrow shafts | 1 | 1 Log | 5 |
| Shortbow | 5 | 1 Log | 10 |
| Oak shortbow | 20 | 1 Oak log | 16.5 |
| Willow shortbow | 35 | 1 Willow log | 41.5 |
| Maple shortbow | 50 | 1 Maple log | 50 |
| Yew shortbow | 65 | 1 Yew log | 67.5 |
| Magic shortbow | 80 | 1 Magic log | 83.3 |

<Info>
  Fletching allows you to create your own ranged weapons and ammunition, making it essential for ranged combat builds.
</Info>

### Runecrafting

Craft runes for magic combat at runecrafting altars.

| Rune | Level | XP | Notes |
|------|-------|-----|-------|
| Air rune | 1 | 5 | Basic elemental rune |
| Mind rune | 2 | 5.5 | Combat spell rune |
| Water rune | 5 | 6 | Basic elemental rune |
| Earth rune | 9 | 6.5 | Basic elemental rune |
| Fire rune | 14 | 7 | Basic elemental rune |
| Body rune | 20 | 7.5 | Combat spell rune |
| Cosmic rune | 27 | 8 | Enchantment rune |
| Chaos rune | 35 | 8.5 | Combat spell rune |
| Nature rune | 44 | 9 | Alchemy rune |
| Law rune | 54 | 9.5 | Teleportation rune |
| Death rune | 65 | 10 | High-level combat rune |
| Blood rune | 77 | 10.5 | Advanced combat rune |

<Info>
  Runecrafting is essential for magic users, allowing you to create your own runes instead of buying them from shops.
</Info>
