...
| `model-bounds.json` | 3D model bounding boxes and footprints for spatial calculations |
...
8. **Model bounds** (`model-bounds.json`) - 3D model bounding boxes
9. **World areas** (`world-areas.json`)
10. **Stores** (`stores.json`)
