...
- Assets cloned from [HyperscapeAI/assets](https://github.com/HyperscapeAI/assets) via Git LFS
- CDN fetching skipped if local manifests exist
...
- Only re-fetched if content changes (ETag validation)
- Assets served directly from CDN (no local clone)
