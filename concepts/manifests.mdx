...
<Info>
Quests support multi-stage progression with different objective types. NPCs referenced in quests must exist in `npcs.json` and be placed in `world-areas.json`.
</Info>
