...
├── ui/             # UI system (consolidated from hs-kit)
│   ├── components/ # Window, Tab, Modal, ItemSlot, etc.
│   ├── controls/   # Form controls (Slider, Toggle, etc.)
│   ├── core/       # Drag-and-drop, edit mode, presets, responsive
│   ├── stores/     # Zustand state stores
│   ├── theme/      # Theme system and animations
│   └── types.ts    # UI type definitions
├── game/           # Game loop and logic
│   ├── components/ # Game-specific components (chat, currency, dialog, etc.)
│   ├── panels/     # Game panels (inventory, equipment, bank, trade, etc.)
│   ├── hud/        # HUD elements (status bars, minimap, etc.)
