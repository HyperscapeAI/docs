...
**Factory Pattern:**
- `createVisualStrategy()` factory selects strategy based on resource type, model path, and manifest config
- Location: `packages/shared/src/entities/world/visuals/createVisualStrategy.ts`
