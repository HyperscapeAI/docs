...
| `avatars.json` | Avatar/character options |
...
| items/ directory | weapons.json, tools.json, resources.json, food.json, misc.json |
| recipes/ directory | cooking.json, firemaking.json, smelting.json, smithing.json |
| gathering/ directory | woodcutting.json, mining.json, fishing.json |

Add new content by editing these JSON files. Server restart required to reload manifests.
