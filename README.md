...
This was fixed in April 2026 with stable Tailwind v3.4.19 using the standard PostCSS pipeline. If you see missing styles in production Docker builds, verify you're on the latest version.
