...
- **WebGPU-Only Rendering**: Modern GPU-accelerated graphics with TSL shaders (Chrome 113+, Edge 113+, Safari 18+) - WebGL removed
- **Instanced Rendering**: Thousands of resources rendered with minimal draw calls using GPU instancing, with depleted model support
- **Live Streaming**: Multi-platform streaming to Twitch, Kick, and X/Twitter with GPU-accelerated encoding and WebGPU diagnostics
