...
### Viewing Skill Progression

Click any skill in the Skills Panel (🧠 icon) to open the **Skill Guide Panel**:

- Shows all unlocks for that skill with level requirements
- Visual indicators: unlocked (green ✓) vs locked (🔒)
- Highlights your next unlock
- Progress tracker showing unlocks achieved
- Scrollable for skills with many unlocks

<Info>
The Skill Guide Panel helps you plan your training by showing what you'll unlock at each level.
</Info>
