...
Hyperscape features 12 skills across combat, gathering, artisan, and support categories. Click any skill in the Skills Panel to view its unlock guide.

### Skill Guide Panel

Click any skill icon in the Skills Panel to open the Skill Guide:

- **View all unlocks** at each level
- **Green checkmarks** for unlocked content
- **Lock icons** for future unlocks
- **Next unlock highlighted** with gold accent
- **Progress tracking**: See how many unlocks you've achieved

<Info>
  The Skill Guide helps you plan your progression by showing exactly what you'll unlock at each level milestone.
</Info>
...
<Info>
  Agility improves stamina regeneration (+1% per level). Higher agility means you can run longer without resting.
</Info>
...
Agility is a unique skill that trains passively as you explore:

**Training**:
- Gain XP by moving through the world (walking or running)
- 100 tiles traveled = 50 XP (batched to prevent spam)
...
- Helps sustain running for longer periods

**Stamina Mechanics**:
- Running drains stamina (affected by inventory weight)
- Walking regenerates stamina (affected by Agility level)
- Idle regenerates stamina faster (affected by Agility level)
- Heavier inventory = faster stamina drain (+0.5% per kg)
- When stamina reaches 0, you're forced to walk

<Info>
Check your total inventory weight in the Equipment Panel. Lighter loads allow you to run longer!
</Info>
