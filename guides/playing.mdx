...
<Warning>
**WebGPU Required**: Hyperscape requires WebGPU for rendering. WebGL is NOT supported.
</Warning>
...
**Check Compatibility**: Visit [webgpureport.org](https://webgpureport.org) to verify your browser/GPU supports WebGPU.

**Why WebGPU?**: All shaders use TSL (Three Shading Language), which only works with WebGPU. There is no WebGL fallback.
