...
The `scripts/deploy-vast.sh` script handles the full deployment:

**Key Steps:**
1. Configure DNS resolution (some Vast containers use internal-only DNS)
2. Pull latest code from main branch
3. Restore environment variables after git reset
