...
```bash
# From ecosystem.config.cjs (commits 547714e, 684b203, 3df4370)
...
STREAM_CAPTURE_CHANNEL=chrome-beta         # Chrome Beta (changed from chrome-dev)
STREAM_CAPTURE_ANGLE=default               # Default ANGLE backend (changed from vulkan)
