...
The client automatically deploys to Cloudflare Pages on push to main via GitHub Actions.
...
- name: Deploy to Cloudflare Pages
  run: npx wrangler pages deploy dist --project-name=hyperscape
  env:
...
This allows `assets.hyperscape.club` to serve assets to all known domains (hyperscape.gg, hyperscape.club, etc.).
