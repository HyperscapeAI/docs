...
**Chrome Canary for Linux WebGPU Support** (Commit d37bbe3, March 13, 2026):
- Switched from Chrome Beta to Chrome Canary (`google-chrome-unstable`) for Linux NVIDIA
- Chrome Beta was experiencing WebGPU initialization failures and rendering artifacts on NVIDIA GPUs
- Chrome Canary provides better WebGPU stability and support on Linux NVIDIA hardware
