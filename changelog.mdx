...
<Update label="Dependency Updates & Duel Arena Fixes" description="February 2026" date="2026-02-25">

### 📦 Dependency Updates

Major dependency updates with breaking changes and security improvements:
...
- **Three.js Update** (commit daba92b): Bumped from 0.182.0 to 0.183.1
  - Minor version update with bug fixes and improvements
  - WebGPU renderer enhancements
  - TSL shader improvements
  - Applied to packages/client
- **ElizaOS Core Update** (commit d3d4029): Bumped from 2.0.0-alpha.11 to 2.0.0-alpha.12
...
- **Vite Plugin React** (commit 3b03962): Bumped from 5.0.4 to 5.1.4
  - Minor version update with React 19 compatibility improvements
  - HMR (Hot Module Replacement) enhancements
- **Lucide React** (commit ac2603a): Bumped from 0.554.0 to 0.575.0
  - Icon library update with new icons and improvements
  - Applied to packages/client
- **Vite Plugin Node Polyfills** (commit 352b93f): Bumped from 0.24.0 to 0.25.0
...
- **Deploy Workflow Updates** (commit 2fa2c61): Fixed and updated deploy workflows
  ...
  - Enhanced Vast.ai deployment workflow
