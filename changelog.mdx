...
<Update label="Asset Repository Updates" description="January 2026" date="2026-01-24">

### 📦 New Assets & Models

Recent additions to the HyperscapeAI/assets repository:

- **Aligned Equipment Models**: Equipment models now properly aligned for character attachment
  - Bronze, steel, and mithril weapons (swords, pickaxes, hatchets) with aligned variants
  - Fishing rods with aligned models for proper hand positioning
  - Improved visual consistency when equipped by characters
- **Bank Chest Model**: New 3D bank chest model added
  - Model path: `asset://models/bank-chest/bank-chest.glb`
  - Scale: 0.5, Y-offset: 0.10
  - Added to stations manifest for bank interactions
- **Prayer Altar**: Complete altar model for prayer restoration
  - Model: `prayer-alter.glb` with scale 1.0 and yOffset 0.25
  - Examine text: "An altar to the gods. Pray here to restore prayer points."
  - Positioned in Central Haven spawn area
- **Cooking Range**: Cooking station model added
  - Model: `cooking-range.glb` with scale 1.0 and yOffset 0.3
  - Reduces burn chance when cooking food
  - Placed in Central Haven for easy access
- **World Areas Expansion**: Central Haven now includes all crafting stations
  - Bank chest at spawn point (0, 0, 0)
  - Furnace and anvil positioned together for smithing workflow (-24, 28) and (-21, 28)
  - Prayer altar at southern area (0, -25)
  - Cooking range near town center (-26, -4)
  - Complete station coverage for all core skills
