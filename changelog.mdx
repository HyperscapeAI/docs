...
<Update label="Multiplayer Sync & Duel Fixes" description="February 2026" date="2026-02-17">

### 🔄 Multiplayer Position & Equipment Sync (PR #875)

Critical fixes for multiplayer synchronization issues affecting remote player rendering and equipment visibility:

- **Position Sync Fix**: Remote players now face correct direction
...
- **Equipment Visibility on Load**: Equipment now appears when VRM loads
...
- **PvP Ranged XP Fix**: Ranged attacks now grant correct XP in duels
