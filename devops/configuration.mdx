...
STREAM_CAPTURE_CHANNEL=chrome-beta           # Chrome Beta (stable) - changed from chrome-dev
STREAM_CAPTURE_ANGLE=default                 # default (auto-select), vulkan, gl, or swiftshader
