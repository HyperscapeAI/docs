...
# Market Configuration (as of commit 34255ee, Feb 26 2026)
# Markets now use native token (WSOL on Solana, WETH on EVM) instead of GOLD token
# MARKET_MINT defaults to WSOL (So11111111111111111111111111111111111112)
# GOLD_MINT is deprecated - use MARKET_MINT instead

# Perps Oracle (disabled by default on devnet)
...
# Duel Arena Visuals System (commit b8f56e81)
DUEL_ARENA_VISUALS_ENABLED=true                 # Enable duel arena visuals system (default: true)
                                                ...
                                                # Fixes players sinking ~0.4m into arena floors

# Combat AI System (commit 51453dae)
STREAMING_DUEL_COMBAT_AI_ENABLED=true           # Enable DuelCombatAI for agents (default: true)
STREAMING_DUEL_LLM_TACTICS_ENABLED=false        # Enable LLM-based combat strategy (default: false)
