...
# GPU Rendering Configuration (commits dd649da, e51a332, 30bdaf0, Feb 27 2026)
# Rendering mode: xorg (preferred) or headless-egl (fallback)
GPU_RENDERING_MODE=xorg                      # Auto-detected by deploy script
DISPLAY=:99                                  # X display (empty for headless EGL)
DUEL_CAPTURE_USE_XVFB=false                  # Use Xorg/EGL, not Xvfb software rendering
