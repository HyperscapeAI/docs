...
STREAM_CAPTURE_HEADLESS=false                # false (Xorg), new (headless EGL), or true (legacy)
                                             # NOTE: Playwright headless option only accepts boolean
                                             # For Chrome's new headless mode, pass headless=false to Playwright
                                             # and add --headless=new to args array (commit dd649da)
...
# Stream Health Monitoring (commit 14a1e1b, Feb 25 2026)
