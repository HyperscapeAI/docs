...
# Start server with migrations disabled
SKIP_MIGRATIONS=true bun run start
```

**Why This Exists:**
- Server's built-in migrations have FK ordering issues (migration 0050 references tables from older migrations)
...
- Fixed in commits: eb8652a, 6a5f4ee
