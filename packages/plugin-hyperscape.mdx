...
actions: [
  ...
  useItemAction,
  dropItemAction,
  pickupItemAction,  // NEW in ElizaOS 1.7 update
...
<Info>
Hyperscape uses ElizaOS 1.7.0 with backwards-compatible shims. LLM API calls support both 1.6.x and 1.7.x interfaces.
</Info>
