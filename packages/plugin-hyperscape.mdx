...
### New Actions in ElizaOS 1.7

**PICKUP_ITEM**: Pick up items from the ground with intelligent matching
- Supports "pick up bronze pickaxe" with word-boundary matching
...
<Info>
ElizaOS 1.7.0 upgrade includes backwards-compatible shims for API changes. The plugin now supports Ollama for local LLM inference.
</Info>
