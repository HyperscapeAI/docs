...
**Breaking Change (Feb 2026)**: WebGL fallback was completely removed in commit 47782ed. Users on browsers without WebGPU will see an error screen with upgrade instructions.
</Warning>
