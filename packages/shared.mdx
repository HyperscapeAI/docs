...
| `StationDataProvider.ts` | Crafting stations with auto-calculated footprints |
| `ProcessingDataProvider.ts` | Cooking, firemaking, smelting, smithing recipes |
| `TierDataProvider.ts` | Equipment level requirements by tier |
