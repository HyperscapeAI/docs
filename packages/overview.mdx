...
Hyperscape is organized as a Turbo monorepo with 8 packages:
...
<CardGroup cols={2}>
  ...
  <Card title="hs-kit" icon="window" href="/packages/hs-kit">
    Custom UI toolkit for game interfaces (NEW)
  </Card>
  <Card title="plugin-hyperscape" icon="robot" href="/packages/plugin-hyperscape">
    ElizaOS integration for AI agents
  </Card>
  <Card title="website" icon="globe" href="/packages/website">
