...
Advanced equipment fitting system for VRM avatars:

- **V2 Export Format** — Relative matrix approach for accurate positioning
- **Tool Support** — Pickaxes, hatchets, fishing rods in equipment panel
- **Scale Preservation** — Maintains bone scale compensation for correct sizing
- **Avatar Normalization** — Normalizes avatar height to 1.6m (matches Hyperscape)
- **OSRS-Style Visuals** — Fishing rod appears in hand during fishing

**V2 Format Features:**
- Uses relative matrix for exact visual relationship between hand bone and weapon
